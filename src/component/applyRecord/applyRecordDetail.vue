...
<template>
    ...
    <div id="apply-record-detail">
        <div class="ui ui-text-list" v-if="!!config.applyInfo.ProxyApplyUserAccount">
            <p v-if="false">申请人账号：{{config.applyInfo.ProxyApplyUserAccount}}</p>
            <p>申请人：{{config.applyInfo.ProxyApplyUserName}}</p>
        </div>
